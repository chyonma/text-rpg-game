...
- **Fight Enemy** – Enter combat with a random enemy  
- **View Stats** – See your current stats, level, and Remnant  
- **View Inventory** – Manage items and equipment  
- **Level Up** – Spend Remnant to upgrade stats  
- **View Equipment** – Check equipped weapon and armor  
- **Rest** – Fully restore HP (free at bonfire)  
- **Save Game** – Save progress to file  
- **Quit** – Exit (option to save before quitting)  
...
- Low HP (<30%): 40% chance to defend, 60% chance to attack
